          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                //     gradient: LinearGradient(
                //       colors: [
                //         AppColors.contractor_secondary.withValues(alpha: 0.60), 
                //         AppColors.contractor_secondary.withValues(alpha: 0.50),
                //       ],
                //       begin: Alignment.topLeft,
                //       end: Alignment.bottomRight,
                //     ),
                ...
                Text(
                  ...
                  style: TextFontStyle.textStyle13c64748BInter400.copyWith(
                    ...
                    fontSize: 20.sp,
                    color: AppColors.scaffoldColor.withValues(alpha: 0.80),
                  ),
                ),
                ...
                CustomButton(
                  ...
                  textStyle: TextFontStyle.textStyle14cFFFFFFInter700.copyWith(
    ...
    return Padding(
      ...
      child: Material(
        ...
        child: ListTile(
          ...
          leading: Icon(
            icon,
            color: selected ? AppColors.contractor_primary : AppColors.scaffoldColor,
          ),
          title: Text(
            label,
            style: TextStyle(
              ...
              fontWeight: FontWeight.w700,
              color:
                  selected ? AppColors.contractor_primary : AppColors.scaffoldColor,
            ),
          ),
          trailing: selected
